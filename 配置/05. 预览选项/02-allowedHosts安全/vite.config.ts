// allowedHosts：Vite 允许响应的主机名（预览服务器）
//
// 类型：string[] | true
// 默认值：继承 server.allowedHosts
//
...
//
// 危险：设置为 true 允许任何网站通过 DNS 重绑定攻击向你的预览服务器发送请求
...
export default defineConfig({
  preview: {
    ...
    // 默认：继承 server.allowedHosts，仅允许 localhost、.localhost 域名和 IP 地址
    // allowedHosts: [],
