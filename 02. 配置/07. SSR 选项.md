...
- **类型:** `string[]`
- **默认:** `['module', 'node', 'development|production']` (`defaultServerConditions`) (`['module', 'browser', 'development|production']` (`defaultClientConditions`) for `ssr.target === 'webworker'`)
- **相关:** [Resolve Conditions](./shared-options.md#resolve-conditions)
